  ...
  render() {
    return (
      <div>
              ...
              <ul className="nav navbar-nav">
                <li className="dropdown active">
                  ...
                  <ul className="dropdown-menu" role="menu">
                    ...
                    <li className="active"><Link to={"/register_account"}>계좌 정보</Link></li>
                  </ul>
                </li>  
        ...
        <form className="form-horizontal" action="/createAccount" method="post">
          ...
          <div className="form-group">
            <label htmlFor="inputAccount" className="col-sm-2 control-label">계좌종류</label>
            <div className="col-xs-4">
              <input type="text" className="form-control" id="inputAccount" />
            </div>
          </div>
          <div className="form-group">
            <label htmlFor="inputDate" className="col-sm-2 control-label">개설일자</label>
            <div className="col-xs-4">
              <input type="date" className="form-control" id="inputDate" />
            </div>
          </div>
          <div className="form-group">
            <label htmlFor="inputCard" className="col-sm-2 control-label">카드신청여부</label>
            <div className="radio col-xs-4">
              <label className="radio-inline">
                <input type="radio" name="optionsRadios" id="inputCard" defaultValue="yes" /> YES
              </label>
              <label className="radio-inline">
                <input type="radio" name="optionsRadios" id="inputCard" defaultValue="no" /> NO
              </label>
            </div>
          </div> 
          <div className="form-group">
